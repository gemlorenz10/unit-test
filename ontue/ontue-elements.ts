...
/**
 * Functions that can be used by other actions in ontue.
 */
export class OntueFunctions extends PuppeteerExtension {
    ...
    */
    getUserData( type?, textFile = path.join( __dirname, '..', 'data', 'register-data.txt')) :IUserInfo[]{
     ...
     */
    getWeekDays( numOfDays?, all : boolean = false ){
